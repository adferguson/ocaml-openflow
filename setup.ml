...
(* OASIS_START *)
(* DO NOT EDIT (digest: 061a57491186eb52f8b993ff2ffdc8b1) *)
(*
...
let setup_t =
  {
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$testtool", ["inline-test-runner"; "dummy"]))
                   ];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     doc = [("doc", OCamlbuildDocPlugin.doc_build "lib")];
     ...
     clean_doc = [("doc", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test =
       [
          ("all_tests",
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the openflow.quickcheck library";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the openflow.lwt library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "install executable for end-to-end test";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["-g"])];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "openflow";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["OpenFlow0x01_Arbitrary"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "openflow";
                      lib_findlib_name = Some "quickcheck";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "OpenFlow documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "Test0.ml"});
               Executable
                 ({
                     cs_name = "ping_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "PingTest.ml"});
               Test
                 ({
                     cs_name = "all_tests";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.1";
     oasis_digest =
       Some "\240H\138\"\186\133n\\\184\001\250\0261\144\252\022";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
